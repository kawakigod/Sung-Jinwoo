...
buttons = [
    [        
        ...
        text="➕ Add Manjiro Sano to your Group", 
        url="t.me/mikey_op_bot?startgroup=true" ),
    ],
    [        
        InlineKeyboardButton(
        text="⚙️ Support", url=f"https://t.me/{SUPPORT_CHAT}"
        ),
        InlineKeyboardButton(
...
def main():
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[I am now ready to fight.](https://telegra.ph/file/1659d37cbfd1ce0c17b56.mp4)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
